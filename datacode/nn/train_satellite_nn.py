...
d1 = h5py.File('/home/hgc-swin/data/satellite_nndata_train.h5', 'r')
d2 = h5py.File('/home/hgc-swin/data/satellite_nndata_test.h5', 'r')
time = d1['time'][:]
...
history = model.fit(d1xq, d1yq, epochs=EPOCHS, validation_split=0.2, verbose=1, callbacks=[early_stop, scheduler])
