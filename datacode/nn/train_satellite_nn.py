...
d1 = h5py.File('satellite_nndata_train.h5', 'r')
d2 = h5py.File('satellite_nndata_test.h5', 'r')
time = d1['time'][:]
...
d2xt = np.stack((d2['Mhdot'][:], d1['mhdot'][:], d1['delta'][:], d2['vcirc'][:], d2['rhalf'][:], d2['skew'][:], d2['minD'][:]), axis=-1)
...
d1xt1q, d1xt1g = GQTvecnorm(d1xt[:,:,0:2])
d1xt2q, d1xt2g = GQTscalnorm(d1xt[:,:,2])
d1xt3q, d1xt3g = GQTvecnorm(d1xt[:,:,3:])
...
d2xt1q, d2xt1g = GQTvecnorm(d2xt[:,:,0:2])
d2xt2q, d2xt2g = GQTscalnorm(d2xt[:,:,2])
d2xt3q, d2xt3g = GQTvecnorm(d2xt[:,:,3:])
