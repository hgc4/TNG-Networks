...
d0 = h5py.File('satellite_nndata_train.h5', 'r')
d1 = h5py.File('satellite_nndata_test.h5', 'r')
d2 = h5py.File('satellite_nndata_pred.h5', 'r')
d3 = h5py.File('satellite_nndata_dark.h5', 'r')
model = keras.models.load_model('satellitemodel.h5')
time = d3['time'][:]
...
d3xt = np.stack((d3['Mhdot'][:], d3['mhdot'][:], d3['delta'][:], d3['vcirc'][:], d3['rhalf'][:], d3['skew'][:], d3['minD'][:]), axis=-1)
d3xs = np.stack((d3['beta_halo'][:], d3['beta_sub'][:], d3['a_inf'][:], d3['a_max'][:], d3['logMu'][:], d3['logVrel'][:], d3['formtime'][:], d3['logMh'][:], d3['logmaxMhdot'][:], d3['logmh'][:], d3['logmaxmhdot'][:]), axis=-1)
